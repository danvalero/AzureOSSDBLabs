...
**Exercise list**
- [Add additional users to an Azure Database for MySQL Single Server Single Server](#add-additional-users-to-an-azure-database-for-mysql-single-server-single-server)
  - [Exercise 1: Create additional admin users in Azure Database for MySQL Single Server](#exercise-1-create-additional-admin-users-in-azure-database-for-mysql-single-server)
  - [Exercise 2: Create database users in Azure Database for MySQL](#exercise-2-create-database-users-in-azure-database-for-mysql)
  ...
  - [Exercise 4: setting and connecting with regular Azure AD users in Azure Database for MySQL](#exercise-4-setting-and-connecting-with-regular-azure-ad-users-in-azure-database-for-mysql)
...
1. Create new database users
   ...
   Create a new database, create a new user and grant CRAETE and INSERT privileges to the new user on the database, by executing:
...
1. Log in to your server, using the new username and create a table
   ...
   When registering the server, make sure you set the default schema to the database where the use has permissions: *testdb*
...
1. Add the Azure AAD non admin user  
   ...
   >Don't use the name of a user or group already set at Admin User for the server:
