...
1. Connect to the Azure VM and install pgAdmin
   ...
   In the VM, open Microsoft Edge and go to https://www.mysql.com/products/workbench/
...
1. Connect to the Azure Database for MySQL from the VM in the VNET
   ...
   When you click **OK**, you will get an error
...
1. Connect to the Azure Database for PostgreSQL from the VM in the VNET
   ...
   Go back to the VM and try to register the Azure Database for MySQL Single Server once again.
