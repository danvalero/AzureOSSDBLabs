...
During this lab, you will learn how to create alerts on metrics for Azure Database for PostgreSQL.
...
- Test an alert rule configured for Azure Database for PostgreSQL
- Manage alerts configured for Azure Database for PostgreSQL
...
This exercise shows how to, create alerts on metrics for Azure Database for PostgreSQL.
...
1. Create an alert for the **Failed Connections** metric
   ...
   - Alert rule name: Failed connections to pgserver[your name initials]
   - Description: 3 failed connections to pgserver[your name initials] in the last 5 minutes.
   - Severity: Sev 3
...
## Exercise 2: Test an alert rule configured for Azure Database for PostgreSQL

This exercise shows how to test an alert on metrics for Azure Database for PostgreSQL.
...
1. Force a failed connection to the Azure Database for PostgreSQL from pgAdmin

   Open **pgAdmin** and register your Azure Database for PostgreSQL using the admin user.
...
## Exercise 3: Manage alerts configured for Azure Database for PostgreSQL

This exercise shows how to, manage alerts configured for Azure Database for PostgreSQL.
